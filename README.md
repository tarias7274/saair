...
load_interval <- lubridate::interval(start = start_date, end = end_date)
# Check interval as a sanity check
paste("Pulling PurpleAir Data Overlapping with Interval", load_interval) |>
  cli::cli_alert_info()
